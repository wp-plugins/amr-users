...
global $amain;
	...
	echo ' <a href="http://wpusersplugin.com/downloads/buy-it/" title="Support development by purchasing membership.">';
	_e('Buy it','amr-users');
	echo '</a>,&nbsp; ';
	echo '<a href="'.admin_url('post-new.php?post_type=post').'" title="Write a post about it.">';
	_e('Press it','amr-users');
	echo '</a>,&nbsp; ';
	echo '<a href="https://www.paypal.com" title="Send to anmari@anmari.com.">';
